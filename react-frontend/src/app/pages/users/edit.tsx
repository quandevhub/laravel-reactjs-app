...
export default function UserEdit() {
    ...
    const hanbleSubmit = async (e: React.MouseEvent<HTMLButtonElement>) => {
        ...
        try {
            ...
            const rep = await UserService.update(taskId, formData);
                    ...
                    <div className="container grid px-6 mx-auto">
                        ...
                        <div className="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                            ...
                            <label className="block mt-4 text-sm">
                                ...
                                <span className="text-red-600">*</span>
                                <input type="radio" name="role" value="1" checked={formData.role == 1} onChange={handleChange} />
                                <label className="ml-2">Admin</label>
                                <input type="radio" name="role" value="0" checked={formData.role == 0} onChange={handleChange} style={{marginLeft: "15px"}} />
