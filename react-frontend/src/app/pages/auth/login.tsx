...
export default function LoginUser() {
    ...
    const hanbleSubmit = async (e: React.MouseEvent<HTMLAnchorElement>) => {
        ...
        try {
            ...
            localStorage.setItem('user',respon.data.user)
            navigate('/tasks')
        } catch (error) {
                ...
                <div className="flex flex-col overflow-y-auto md:flex-row">
                    ...
                    <div className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                        <div className="w-full">
                            ...
                            <p className="mt-4">
                                <Link to="/forgot-password" className="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline">Forgot your password?</Link>
                            </p>
                            <p className="mt-1">
                                <Link to="/user/register" className="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline">Create account</Link>
                            </p>
                        </div>
                    </div>
                </div>
